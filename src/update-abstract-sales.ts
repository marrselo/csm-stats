...
export async function updateAbstractSales(nodeName: string, chunkSize: number, recreateTable = false) {
	...
	const companiesMap = Object.fromEntries(companies.map((c) => [c.id, c.aclId]))
